...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = BrakePressureSensor_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(BrakePressureSensor_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(BrakePressureSensor_GPIO_Port, BrakePressureSensor_Pin);
